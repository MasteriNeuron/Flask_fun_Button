...
def select_converter():
    if(request.method == "POST"):
       if request.form["btn_choice"] == "Celcius to Fahrenheit":
            return render_template("converter/ctof.html")
       if request.form["btn_choice"] == "Fahrenheit to Celcius":
            return render_template("converter/ftoc.html")
       if request.form["btn_choice"] == "Inches to Feet":
            return render_template("converter/itof.html")
       if request.form["btn_choice"] == "Feet to Inches":
